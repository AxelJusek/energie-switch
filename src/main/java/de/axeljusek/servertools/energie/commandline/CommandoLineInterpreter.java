...
public class CommandoLineInterpreter {
  ...
  private void commandoUmsetzen(SortedSet<Commando> commandos) throws IOException {
    ...
    var verbindungsDaten = Verbindungsdaten.getVerbindungsDatenFromCommandos(commandos);
  ...
  private SortedSet<Commando> convertIntoCommandos(String[] args,
      SortedSet<Commando> operationsParameter) {
    int anzahlParameter = args.length;
    String argument = "";
  ...
  private void hilfetextAusgeben() {
    ...
    System.out
        .println("Diese Software ben��tigt JDK 11 und aktueller und eine Konfigurationsdatei.\n");
    System.out.println(
    ...
    System.out
        .println("Die folgenden Parameter k��nnen in der Konfigurationsdatei hinterlegt werden:");
    System.out.println(
        "ip_address - Die IP-Adresse der Steckdosenleiste, die genutzt werden soll, Standard ist 192.168.0.254 .");
    System.out
        .println("port - Die Port-Nr auf welche die Steckdosenleiste h��rt, Standard ist 5000 .");
    System.out.println(
    ...
    for (ParameterKommandozeile para : ParameterKommandozeile.values()) {
      System.out.println(stretchString(para.getParameter(), 10) + ""
          + stretchString(para.getWerteListe(), 30) + "" + para.getErlaeuterungstext() + "");
    }
    System.out.println(" ");
    System.out.println("Beispiele zur Veranschaulichung des Einsatzes");
    System.out.println(" ");
    System.out
        .println("Zur Ausgabe dieses Textes: $JAVA_HOME/bin/java -jar energenie_switch.jar -h");
    System.out.println(
