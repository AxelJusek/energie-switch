...
public class Commando implements Comparable<Commando> {
  ...
  /**
   * We do not compare the object with each other, just their index. Therefore we leave the equals
   * and hashCode as they are. TODO While we need this only to sort for the execution order, an
   * external Comparator may be the cleaner solution here.
   */
  @Override
