...
public enum ParameterKommandozeile {
  ...
  SchaltenEinerDoseGewuenschterZustand("-d", true, null, "true | false",
      "Der gewuenschte Schaltzustand: True steht fuer ein und False fuer aus."),

  SchaltenEinerDoseDosenNr("-s", true, ParameterKommandozeile.SchaltenEinerDoseGewuenschterZustand,
      "0 | 1 | 2 | 3", "Die Nummer der Dose die geschaltet werden soll."),

  IpAdresseAngeben("-ip", true, null, "z.B. 192.168.0.254",
      "Die IP-Adresse über welche die Steckdosenleiste erreicht wird."),

  PortNrAngeben("-port", true, null, "z.B. 5000",
      "Die Port-Nummer auf welche die Steckdosenleiste hört."),
